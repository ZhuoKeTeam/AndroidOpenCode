 ...
 * Copy from https://github.com/wuapnjie/SwipePostcard
 */

public class SwipePostcardView extends FrameLayout {
    ...
    public SwipePostcardView(Context context) {
        super(context);
        init(context);
    }

    public SwipePostcardView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        init(context);
    }

    public SwipePostcardView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    @TargetApi(21)
    public SwipePostcardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
//            mOnPostcardRunOutListener.onPostcardRunOut();
    ...
    private void addPostcards(int position) {
        ...
        if (position == 0) {
            ...
            postCard.setScaleX(0.9f);
            postCard.setScaleY(0.9f);
            postCard.setTranslationY(2 * mOffsetY);
//            postCard.animate().scaleX(0.9f).scaleY(0.9f).setDuration(200).start();
        }
        addView(postCard, 0);
        mCurrentPosition++;
        //TODO 设置自身高度显示3个
